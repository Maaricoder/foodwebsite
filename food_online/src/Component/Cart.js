...
const Cart = () => {
    ...
    return (
        !products.length
        ? <img className="mx-auto w-1/2 mt-3 " src="/img/new_cart.png" alt="" />
        :
        <div className="container mx-auto lg:w-1/2 w-full pb-24">
            ...
            <div className="text-right mt-6">
                <button onClick={orderplace}  className="bg-yellow-500 px-4 py-2 rounded-full leading-none">Order Now</button>
            </div>
        </div>
    )
}
